...
*****
This implementation allows the number of feature maps is not divided by the channel number of per Group. E,g. one can use group size of 64 when the channel number is 80. (64 + 16)
